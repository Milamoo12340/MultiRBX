...
const RECOMMENDED_TOOLS = [
  ...
  },
  {
    ...
    desc: 'Open source fork, 511+ stars, 2026 releases. Watcher process holds ROBLOX_singletonMutex. Only download from github.com/fishstrap/fishstrap.',
    verdict: 'Recommended',
    verdictColor: 'text-[hsl(150,100%,45%)] border-[hsl(150,100%,45%)/0.3] bg-[hsl(150,100%,45%)/0.1]',
    internal: false,
  },
  {
    ...
    desc: 'Active Bloxstrap fork (194 stars, 58+ releases). Multi-instance included. Only from github.com/voidstrap/Voidstrap.',
    verdict: 'Recommended',
    verdictColor: 'text-[hsl(150,100%,45%)] border-[hsl(150,100%,45%)/0.3] bg-[hsl(150,100%,45%)/0.1]',
    internal: false,
  },
  {
    name: 'MultiBlox Python GUI',
    url: 'https://github.com/unknownperson-vos/MultiBlox',
    desc: 'Python GUI app (16 stars). Uses NtQuerySystemInformation + DuplicateHandle. Closes both singleton handles. Only from github.com/unknownperson-vos/MultiBlox.',
    verdict: 'Recommended',
    verdictColor: 'text-[hsl(150,100%,45%)] border-[hsl(150,100%,45%)/0.3] bg-[hsl(150,100%,45%)/0.1]',
    internal: false,
  },
  ...
  {
    name: 'MultiBloxy (Zgoly)',
    url: 'https://github.com/Zgoly/MultiBloxy',
    desc: 'Open source tray app (C#). Roblox actively patches it since 2024. Check github.com/Zgoly/MultiBloxy/issues for current status before using.',
